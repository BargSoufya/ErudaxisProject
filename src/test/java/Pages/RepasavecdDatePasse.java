...
public class RepasavecdDatePasse {

	@FindBy(css="body > div.MuiDialog-root.MuiModal-root.css-10pksy > div.MuiDialog-container.MuiDialog-scrollPaper.css-16u656j > div > div.MuiDialogContent-root.css-12of8pw > div > div:nth-child(1) > div > input")
	WebElement NomRepas;
	...
	public RepasavecdDatePasse() {

		PageFactory.initElements(Config.driver,this);
		}
	
	public void ajouterRepasavecleschamps(String Nom,String date,String des,int price, int qte) {
	...
	public void SaisirNom (String Nom) {
		 ...
		 WebDriverWait wait = new WebDriverWait(Config.driver, Duration.ofSeconds(10));
		    ...
		    WebElement nomField = wait.until(
		        ExpectedConditions.elementToBeClickable(
		            By.cssSelector("input[placeholder='Ex: Pizza Margherita']")
		        )
		    );

		    // Cliquer, vider et saisir caractère par caractère
		    act.moveToElement(nomField)
		       .click()
		       .pause(500)
		       .sendKeys(Nom)
		       .pause(500)
	    ...
	    System.out.println("Nom du repas saisi : " + Nom);
	}
