...
public class AjouterRepasAvecNomExistantPage {
	...
	public AjouterRepasAvecNomExistantPage() {

		PageFactory.initElements(Config.driver,this);
		}
		
	
	public void ajouterRepasavecleschamps(String Nom,String date,double price, int qte) {
	...
	public void saisirNom(String nom) {
	    WebDriverWait wait = new WebDriverWait(Config.driver, Duration.ofSeconds(10));
	    wait.until(ExpectedConditions.visibilityOf(NomRepas));
	...
	//}
		...
		public void creerUnrepasNomExistant () {
			WebDriverWait wait = new WebDriverWait(Config.driver, Duration.ofSeconds(15));
		    Actions act = new Actions(Config.driver);
